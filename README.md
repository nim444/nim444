...
| [featherbar](https://github.com/nim444/featherbar) `Rust` | Featherweight macOS `menu bar` system monitor — RAM/CPU/power, zero background threads, flat memory · on [crates.io](https://crates.io/crates/featherbar) |
